...
const ForecastHariIni = ({ timestamp, location, data, dataHargaKomoditas }) => {
  ...
  const lengthDataHargaKomoditas = dataHargaKomoditas ? dataHargaKomoditas.length : 0;

  const totalSlides = Math.ceil(
    lengthDataHargaKomoditas / itemsPerView
  );
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 mb-3">
                              ...
                              <div className="flex-1">
                                <h3 className="text-sm font-semibold text-gray-800 line-clamp-1" title={item.nama}>
                                  {item.nama}
                                </h3>
