...
const ForecastHariIni = ({ weatherData }) => {
    return (
        <div className="w-full lg:w-3/5 space-y-6">
          <div className="rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="p-6">
              <div className="space-y-8">
                  <ItemCurrentTime weatherData={weatherData} />
                  
                  <div className="flex-1 bg-gray-50 rounded-2xl p-6 w-full">
                    <p className="mb-4 text-sm font-medium">Perkiraan Cuaca Hari Ini</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {weatherData.statusMetrics.map((metric, i) => {
              ...
              return (
                <ItemStatusForecast key={i} metric={metric} Icon={Icon} />
              );
            })}
          </div>
        </div>
